...
const Testimonial: React.FC<TestimonialProps> = ({
  ...
  return (
    <>
      <div className="md:w-[416px] w-[294px] md:h-[310px] h-[348px] bg-CardColor rounded-[12px] border md:border-black border-white">
        <div className="flex space-x-2 mt-[32px] xl:ml-[32px] ml-[24px]">
          {Array.from({ length: 5 }, (_, index) => (
            <img key={index} src="/color.svg" alt={`Color ${index + 1}`} />
          ))}
        </div>
        <div className="md:w-[352px] w-[270px] md:h-[108px] h-[162px]">
