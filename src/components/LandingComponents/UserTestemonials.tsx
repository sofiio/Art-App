  ...
  return (
    <div className="w-full md:bg-white bg-black">
      <div className="xl:max-w-[1312px] mx-auto xl:h-[780px] md:h-[1394px] h-[500px] font-black xl:font-normal flex flex-col items-center">
        ...
        <div className="2xl:w-[1312px] xl:w-[1100px] w-[355px] sm:w-[500px] md:w-[543px] overflow-x-auto overflow-y-hidden example scrollbar-hide xl:h-[311px] flex md:flex md:flex-col xl:flex xl:flex-row items-center xl:mt-[80px] mt-[24px] md:mt-[80px] p-4 xl:p-0 md:space-y-6 xl:space-y-0">
          <div>
            <Testimonials
          ...
          <div className="xl:ml-[32px] sm:ml-[28px] ml-[25px] md:ml-0">
            <Testimonials
