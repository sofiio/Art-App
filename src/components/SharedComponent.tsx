...
const SharedComponent: FC<SharedComponentProps> = ({
  ...
  return (
    <>
      ...
      />
      <div className="lg:w-[768px] md:w-[700px] w-[343px] sm:w-[500px] md:mt-[80px] mt-[23px] mx-auto">
      ...
      {sections.map((section, index) => (
        <React.Fragment key={index}>
          <img
            src={section.image}
            alt=""
            className="mx-auto md:mt-[80px] mt-[16px] 2xl:w-auto lg:w-[768px] md:w-[700px] w-[343px] sm:w-[500px] h-[250px] md:h-auto"
          />
          <div className="lg:w-[768px] md:w-[700px] w-[343px] sm:w-[500px] md:mt-[80px] mt-[23px] mx-auto">
